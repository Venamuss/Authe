...
const file_api_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x1capi/proto/user/v1/user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbe\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\busername\x18\x02 \x01(\tR\busername2\xa1\x01\n" +
	"\vUserService\x12H\n" +
	"\vGetUserByID\x12\x1b.user.v1.GetUserByIDRequest\x1a\x1c.user.v1.GetUserByIDResponse\x12H\n" +
	"\vVerifyToken\x12\x1b.user.v1.VerifyTokenRequest\x1a\x1c.user.v1.VerifyTokenResponseB!Z\x1fauthe/pkg/proto/user/v1;user_v1b\x06proto3"
...
var file_api_proto_user_v1_user_proto_goTypes = []any{
	...
	(*VerifyTokenRequest)(nil),    // 3: user.v1.VerifyTokenRequest
	(*VerifyTokenResponse)(nil),   // 4: user.v1.VerifyTokenResponse
...
var file_api_proto_user_v1_user_proto_depIdxs = []int32{
	...
	1, // 3: user.v1.UserService.GetUserByID:input_type -> user.v1.GetUserByIDRequest
	3, // 4: user.v1.UserService.VerifyToken:input_type -> user.v1.VerifyTokenRequest
	2, // 5: user.v1.UserService.GetUserByID:output_type -> user.v1.GetUserByIDResponse
	4, // 6: user.v1.UserService.VerifyToken:output_type -> user.v1.VerifyTokenResponse
